...
//  Pitch Perfect
//
//  Created by Andrew Ehsaei on 1/12/15.
...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if var filePath = NSBundle.mainBundle().pathForResource("Bruh", ofType: "mp3") {
    ...
    */
    ...
    @IBAction func playSlow(sender: UIButton) {
        //play audio clip slooowwly here
        audioPlayer.stop()
